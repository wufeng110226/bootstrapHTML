...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _checkDimensions: function (i, chk, $img, $thumb, fname, type, params) {
            ...
            //self.parents('.form-group').find('.fileinput-upload-button').attr('disabled', true);   //wf addmethod
            $("#"+params.id).parents('.form-group').find('.fileinput-upload-button').attr('disabled', true);
            //console.log();
    ...
    $.fn.fileinputLocales['zh'] = {
        ...
        msgImageWidthSmall: '图像文件的"{name}"的宽度必须至少为{size}像素.',
